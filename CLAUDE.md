...
| 4.3b Stories overlays (MENTION/STICKER/TAG + multi-touch scale/rotate) | Chưa bắt đầu |
| 4.4 Stories archive + cron (isArchived cron + archive page + profile ring entry + view count/viewers list) | ✅ Xong (AudioTrack defer) |
| 5-7 | Chưa bắt đầu |
