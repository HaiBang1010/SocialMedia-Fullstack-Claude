...
| 5.3b Messaging GROUP read receipts UI ("Seen by N") — FE-only | Chưa bắt đầu |
| 5.4-5.5 Messaging (media/voice, recall, post-share, group UI) | Chưa bắt đầu |
| 6-7 | Chưa bắt đầu |
